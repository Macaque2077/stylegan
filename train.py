...
if 1:
    ...
    # Dataset.
    desc += '-custom';  dataset = EasyDict(tfrecord_dir='C:/Users/youk3/OneDrive/Desktop/Thesis/git_projects/stylegan/datasets/fish/tfrecord'); train.mirror_augment = True
